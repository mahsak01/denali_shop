...
$.extend($.easing, {
    def: "easeOutQuad", swing: function (t, e, a, i, o) {
    ...
    Wolmart.$window = t(window), Wolmart.$body = t(document.body), Wolmart.status = "", Wolmart.isIE = navigator.userAgent.indexOf("Trident") >= 0, Wolmart.isEdge = navigator.userAgent.indexOf("Edge") >= 0, Wolmart.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Wolmart.call = function (t, e) {
        ...
        var e = window.pageXOffset, a = window.pageYOffset, i = t.getBoundingClientRect(), o = i.left + e,
            n = i.top + a;
        ...
        Wolmart.$body.on("click", ".tab .nav-link", function (e) {
            ...
            var a = t(e.currentTarget).attr("href"), i = t(a), o = i.parent().siblings(".nav");
            e.preventDefault(), i.siblings().removeClass("active in"), i.addClass("active in"), o.find(".nav-link").removeClass("active"), o.find('[href="' + a + '"]').addClass("active"), t("html").animate({scrollTop: i.offset().top - 150})
        })
        ...
        return e.prototype.init = function (e, a) {
            ...
            var i = window.pageYOffset + a.offsetTop, o = this.$el;
            ...
            window.addEventListener("scroll", a, {passive: !0}), Wolmart.$window.on("resize", i), setTimeout(function () {
                i()
            }, 300)
        }), function (a, i) {
        ...
        t.fn.isotope && Wolmart.$(e).on("click", function (e) {
            var a = t(this), i = a.attr("data-filter"), o = a.parent().parent().attr("data-target");
            t(o || ".grid").isotope({filter: i}).isotope("on", "arrangeComplete", function () {
        ...
        }, o = 0; o < a; ++o) e[o].addEventListener("mouseover", i), e[o].addEventListener("touchstart", i, {passive: !0})
    }, Wolmart.setProgressBar = function (e) {
        Wolmart.$(e).each(function () {
            var e = t(this), a = e.parent().find("mark")[0].innerHTML, i = "";
        ...
        Wolmart.$body.on("click", e, function (e) {
            var i = t(this), o = i.closest(".card").find(i.attr("href")), n = i.closest(".accordion");
        ...
        t.fn.countdown && Wolmart.$(e).each(function () {
            var e = t(this), a = e.data("until"), i = e.data("compact"),
            ...
            if (e.data("relative")) l = a; else var r = a.split(", "), l = new Date(r[0], r[1] - 1, r[2]);
            e.countdown({
                until: l,
                format: o,
                padZeroes: !0,
        ...
        init: function () {
            ...
            var e = void 0 === t ? 0 : t, o = i.splice(e, 1)[0];
            n.splice(e, 1)[0];
        ...
        if ("number" == typeof e) n = e; else {
            ...
            var n = o.offset().top, s = t("#wp-toolbar");
        ...
        init: function () {
            ...
            t(".menu li").each(function () {
                ...
                t(".main-nav megamenu").each(function () {
                    var e = t(this), a = e.offset().left, i = a + e.outerWidth() - (window.innerWidth - 20);
            ...
            t(".widget-collapsible .widget-title").each(function () {
                ...
                var a = t(this), i = a.siblings(".widget-body");
    ...
    var e = function (t) {
        ...
        if (e.match(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g) && this.setAttribute("class", e.replace(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g, "").replace(/\s+/, " ")), this.classList.contains("animation-slider")) for (var a = this.children, i = a.length, o = 0; o < i; ++o) a[o].setAttribute("data-index", o + 1)
    }, a = function (t) {
        var e, a = this.firstElementChild.firstElementChild.children, i = a.length;
        for (e = 0; e < i; ++e) if (!a[e].classList.contains("active")) {
            var o, n = Wolmart.byClass("appear-animate", a[e]);
            for (o = n.length - 1; o >= 0; --o) n[o].classList.remove("appear-animate")
        }
    }, i = function (e) {
        t(window).trigger("appear.check");
        var a = t(e.currentTarget), i = a.find(".owl-item.active video");
        ...
        t(e.currentTarget).find(".owl-item.active .slide-animate").each(function () {
            var e = t(this),
                ...
                o = i.duration, n = i.delay, s = i.name;
            setTimeout(function () {
        ...
        var a = this, i = t(e.currentTarget);
    ...
    Slider.defaults = {
        ...
        var d = l.attr("class").split(" "), u = t.extend(!0, {}, Slider.presets, Slider.defaults);
    ...
    var e = {
        init: function () {
            ...
            Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(Wolmart.setProgressBar(".progress-bar"), 500), this.initProductType("slideup"), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Wolmart.$body.on("mousedown", ".select-menu", function (e) {
                var a = t(e.currentTarget), i = t(e.target), o = a.hasClass("opened");
                ...
                e.preventDefault();
                var a = t(this), i = a.closest(".product, .product-popup");
                ...
                i.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">مقایسه محصولات</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">حذف همه</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">شروع مقایسه !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'), i = t(".page-wrapper > .compare-popup")), Wolmart.$body.on("click", ".product .btn-compare", function (n) {
                    ...
                    i.preventDefault();
                    var n = t(i.currentTarget).closest("li"), s = n.index(), r = n.find("img").attr("src");
                    ...
                    i.preventDefault(), t(".page-wrapper .product img").each(function () {
                        var e = t(this), i = this.getAttribute("src");
            ...
            t(".product:not(.product-single) .product-variations > a").on("click", function (e) {
                var a = t(this), i = a.closest(".product").find(".product-media img");
    ...
    var e = {
        ...
        var e = t.$thumbsWrap.offset().top + t.$thumbsWrap[0].offsetHeight, a = t.$thumbs.offset().top + t.thumbsHeight;
        ...
        var e = t.$thumbsWrap.offset().top, a = t.$thumbs.offset().top;
    ...
    ProductSingle.prototype.init = function (e) {
        var r = this, l = e.find(".product-single-carousel");
        r.$wrapper = e, r.isQuickView = !!e.closest(".mfp-content").length, r._isPgVertical = !1, r.isQuickView && (n = n.bind(this), Wolmart.ratingTooltip()), l.on("initialized.owl.carousel", function (e) {
            document.body.classList.contains("home") || (r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-image-full"><i class="w-icon-zoom"></i></a>'), l.parent().hasClass("product-gallery-video") && (r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="گالری محصول 360 درجه"><i class="w-icon-rotate-3d"></i></a>'), r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-video-viewer" title="ویدئو تصویر کوچک محصول"><i class="w-icon-movie"></i></a>'))), function (e) {
                e.$thumbs = e.$wrapper.find(".product-thumbs"), e.$thumbsWrap = e.$thumbs.parent(), e.$thumbUp = e.$thumbsWrap.find(".thumb-up"), e.$thumbDown = e.$thumbsWrap.find(".thumb-down"), e.$thumbsDots = e.$thumbs.children(), e.thumbsCount = e.$thumbsDots.length, e.$productThumb = e.$thumbsDots.eq(0), e._isPgVertical = e.$thumbsWrap.parent().hasClass("product-gallery-vertical"), e.thumbsIsVertical = e._isPgVertical && window.innerWidth >= 992, e.$thumbDown.on("click", function (t) {
                    ...
                    var i = t(this), o = (i.parent().filter(e.$thumbs).length ? i : i.parent()).index(),
        ...
        var e = this, a = e.$thumbsDots.eq(t);
        ...
        var a = this, i = t(e.currentTarget), o = (i.parent().children(".active").index(), i.index() + 1);
    ...
    function e(e) {
        ...
        if ((a = o.closest(".review-image").length ? o.closest(".review-image").find("img") : n.find(".product-single-carousel").length ? n.find(".product-single-carousel .owl-item:not(.cloned) img:first-child") : n.find(".product-gallery-carousel").length ? n.find(".product-gallery-carousel .owl-item:not(.cloned) img") : n.find(".product-image img:first-child")).length) {
            ...
            if ("undefined" != typeof PhotoSwipe) {
                var l = t(".pswp")[0], c = new PhotoSwipe(l, PhotoSwipeUI_Default, i, {index: r, closeOnScroll: !1});
    ...
    function o(e) {
        var a = t(this), i = t(".main-content > .alert, .container > .alert");
    ...
    Wolmart.initProductSinglePage = function () {
        Wolmart.zoomImage(".product-gallery .product-image"), function (e) {
            var a = t(e), i = a.closest(".product-single"),
    ...
    Calendar.defaultOptions = {
        ...
        var i = t("<table></table>"), o = t("<thead></thead>"), n = t("<tbody></tbody"), s = e.getFullYear(),
            r = e.getMonth(), l = new Date(s, r, 1), c = new Date(s, r + 1, 0), d = l.getDay();
        ...
        var a = t(e), i = a.closest(".page-content").find(".toolbox .vendor-search-toggle"), o = a.find(".store-phone");
        ...
        var a = t(e), i = a.parent().find(".login-vendor"), o = a.find(".check-customer");
